...
namespace JustFileComparerCore.FileEnumerations
{
    public static class FileEnumerator
    {
        ...
        public static async IAsyncEnumerable<string> EnumerateFilesAsyncStreamed(string root, string searchPattern = "*", uint maxWorkerCount = 0, [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
